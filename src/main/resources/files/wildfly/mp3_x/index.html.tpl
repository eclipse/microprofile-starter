...
<h3>Health</h3>
<a href="[# th:text="${wf_manage_url}"/]/health/live" target="_blank" >Health (Live) status (with custom status)</a> <br/>
<a href="[# th:text="${wf_manage_url}"/]/health/ready" target="_blank" >Health (Ready) status (with custom status)</a> <br/>
[/]
