...
GraphQL is a query language for APIs and a runtime for fulfilling those queries with your existing data. Specification [here](https://microprofile.io/project/eclipse/microprofile-graphql)
